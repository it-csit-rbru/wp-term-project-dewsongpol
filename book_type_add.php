            ...
            <div class="row">
                ...
                <?php
                    if(isset($_GET['submit'])){
                        ...
                        mysqli_close($conn);
                        echo "เพิ่มคำนำหน้า $bt_name เรียบร้อยแล้ว<br>";
                        echo '<a href="book_type_list.php">แสดงชนิดหนังสือทั้งหมด</a>';
                    }else{
                ?>
                    <form class="form-horizontal" role="form" name="book_type_add" action="<?php echo $_SERVER['PHP_SELF']?>">
                        <div class="form-group">
                            <label for="bt_name" class="col-md-2 col-lg-2 control-label">ชนิดหนังสือ</label>
                            <div class="col-md-10 col-lg-10">
                                <input type="text" name="bt_name" id="bt_name" class="form-control">
                            </div>    
                        </div>
                        <div class="form-group">
                            <div class="col-md-10 col-lg-10">
